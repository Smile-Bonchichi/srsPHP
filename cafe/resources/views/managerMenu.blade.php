...
@section('content')
    <p> <div class="list-group">
        <center> <h1> Меню менеджера </h1> </a> </center>
    </div> </p>

    <div class="list-group">   
        <center> <a href="{{ url('/viewMenu') }}" class="list-group-item list-group-item-action badge badge-warning col-sm-2"> <h5> Посмотреть меню </h5> </a> </center>
    </div>
